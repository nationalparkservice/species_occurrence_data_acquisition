...
sppList <- merge(sppList, localeCount,
                     by.x = "taxonKey", by.y = "taxonKey",
                     all.x = TRUE, all.y = FALSE) |> 
  merge(sppDoYs, by.x = "taxonKey", by.y = "taxonKey",
        all.x = TRUE, all.y = FALSE) |> 
...
See the `r paste0(params$UnitCode, "_SpeciesTable.csv")` delimited output table for the externally-sourced species occurrence data for `r params$UnitName`. Column definitions are noted in Table 11. 
